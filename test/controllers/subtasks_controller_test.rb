...
class SubtasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subtask" do
    assert_difference('Subtask.count') do
      post subtasks_url, params: { subtask: { completed: @subtask.completed, description: @subtask.description, list_id: @subtask.list_id } }
    end
  ...
  test "should update subtask" do
    patch subtask_url(@subtask), params: { subtask: { completed: @subtask.completed, description: @subtask.description, list_id: @subtask.list_id } }
